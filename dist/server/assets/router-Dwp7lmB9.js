...
const appCss = "/assets/styles-BEg9EhWK.css";
...
const s2v = "/assets/S2V-BxjlO8t4.png";
const links = [
  { to: "/", label: "Overview" },
  { to: "/meet", label: "Meet" },
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "group flex items-center gap-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl p-2 shadow-lg hover:shadow-2xl transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: s2v, className: "w-12", alt: "" }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center gap-1 md:flex", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  activeProps: {
                    className: "rounded-lg px-3.5 py-2 text-sm text-foreground bg-white/5"
                  },
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 rounded-2xl glass-strong p-2 md:hidden animate-fade-in", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: l.to,
            ...
            activeProps: {
              className: "block rounded-lg px-3 py-2.5 text-sm text-foreground bg-white/10"
            },
            activeOptions: { exact: true },
            children: l.label
          },
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative mt-32 border-t border-white/5 pt-16 pb-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-x-0 -top-px mx-auto h-px max-w-3xl bg-gradient-to-r from-transparent via-white/30 to-transparent" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-r from-purple-300 to-pink-200 glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center justify-center w-5 rounded-xl glow ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: s2v,
                alt: "S2V Logo",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-base font-semibold", children: "S2V" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-sm text-sm text-muted-foreground", children: "Bridging communication between silence and sound. AI-powered assistive technology for the deaf and blind community." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "text-muted-foreground hover:text-foreground", children: "Overview" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/meet", className: "text-muted-foreground hover:text-foreground", children: "Meet Mode" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/modules", className: "text-muted-foreground hover:text-foreground", children: "Modules Mode" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/lecture", className: "text-muted-foreground hover:text-foreground", children: "Lecture Mode" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "sign2voice.team@gmail.com" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Salem, TamilNadu, India" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 flex flex-col items-start justify-between gap-3 border-t border-white/5 pt-6 text-xs text-muted-foreground sm:flex-row sm:items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " S2V — Sign to Voice Solutions. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "opacity-70", children: "Designed for inclusion." })
      ] })
    ] })
  ] });
}
function Loader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      "aria-hidden": done,
      className: `pointer-events-none fixed inset-0 z-[100] flex items-center justify-center bg-background transition-opacity duration-700 ${done ? "opacity-0" : "opacity-100"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col items-center gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-16 w-16", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 animate-spin-slow rounded-full border-t-2 border-r-2 border-accent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-2 flex items-center justify-center rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: s2v,
              alt: "S2V Logo",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-sm tracking-[0.3em] text-muted-foreground", children: "S2V" })
      ] })
    }
  );
}
...
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "S2V — AI-powered assistive technology bridging communication for deaf and blind individuals. Sign Language to Voice. Voice to Text. Real-time."
      },
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen overflow-x-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-none fixed inset-0 -z-10 overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -left-40 top-20 h-[480px] w-[480px] rounded-full bg-primary/30 blur-[140px]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-40 top-[40vh] h-[520px] w-[520px] rounded-full bg-accent/25 blur-[160px]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/3 top-[120vh] h-[420px] w-[420px] rounded-full bg-neon/20 blur-[140px]" })
      ] }),
...
const $$splitComponentImporter$4 = () => import("./modules-DSqGI-nv.js");
const Route$4 = createFileRoute("/modules")({
  head: () => ({
    meta: [{
      title: "Modules Mode — Learn. Practice. Improve. | S2V"
    }, {
      name: "description",
      content: "Modules Mode helps users learn and practice sign language with guided feedback, accuracy scoring, and beginner-friendly word sets."
    }, {
      property: "og:title",
      content: "Modules Mode — S2V"
    }, {
      property: "og:description",
      content: "Learn sign language with guided feedback and practice modules."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./meet-DjbHXknV.js");
const Route$3 = createFileRoute("/meet")({
  head: () => ({
    meta: [{
      title: "Meet Mode — Talk Without Speaking | S2V"
    }, {
      name: "description",
      content: "Meet Mode enables real-time communication by converting sign language into voice and speech into text — seamless conversations for everyone."
    }, {
      property: "og:title",
      content: "Meet Mode — S2V"
    }, {
      property: "og:description",
      content: "Talk without speaking. Real-time sign-to-voice and voice-to-text."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./lecture-B6WJH-Bo.js");
const Route$2 = createFileRoute("/lecture")({
  head: () => ({
    meta: [{
      title: "Lecture Mode — Inclusive Learning for Everyone | S2V"
    }, {
      name: "description",
      content: "Lecture Mode supports classrooms by converting teacher speech into text and student signs into voice — accessible education in real time."
    }, {
      property: "og:title",
      content: "Lecture Mode — S2V"
    }, {
      property: "og:description",
      content: "Inclusive classrooms with live captions and sign-to-voice."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./contact-Bsp1kh-f.js");
const Route$1 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      property: "og:description",
      content: "Let's build inclusive communication together."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-PTJYgeQl.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "S2V is an intelligent assistive device that translates sign language into voice and converts speech into text in real time."
    }, {
      property: "og:title",
      content: "S2V — Sign to Voice System"
    }, {
      property: "og:description",
...
const ModulesRoute = Route$4.update({
  id: "/modules",
  path: "/modules",
  getParentRoute: () => Route$5
});
const MeetRoute = Route$3.update({
  id: "/meet",
  path: "/meet",
  getParentRoute: () => Route$5
});
const LectureRoute = Route$2.update({
  id: "/lecture",
  path: "/lecture",
  getParentRoute: () => Route$5
});
